...
void AAoE_Projectile::DealDamage(AActor* MyOwner, AActor* OtherActor)
{
	...
	//DrawDebugSphere(GetWorld(), GetActorLocation(), InnerImpactRadius, 10, FColor::Red, true);
	//DrawDebugSphere(GetWorld(), GetActorLocation(), OuterImpactRadius, 10, FColor::Yellow, true);
}
