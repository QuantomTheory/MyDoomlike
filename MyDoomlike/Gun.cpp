...
void AGun::LoadClip()
{
	...
	else 
	{
		...
		if (ReloadAnimation != nullptr)
		{
			...
			{
				DisableWeapon();
				// Gets the length of the reload animation and disables the weapon for that length of time.
				ReloadTime = (ReloadAnimation->GetPlayLength()) / 2; // The time is divided by two as the animation plays at twice speed in UE5
