...
ABaseEnemy::ABaseEnemy()
{
	...
	AttackCollision->SetupAttachment(GetMesh(), TEXT("FX_Trail_01_R"));
...
void ABaseEnemy::BeginPlay()
{
	...
	// Sets the attack collision to ignore to prevent damaging itself or other actors when not attacking.
...
void ABaseEnemy::Tick(float DeltaTime)
{
	...
	if (AIController != nullptr)
	{
		...
		{
			// Sets the attack collision to overlap to allow damaging while attacking.
